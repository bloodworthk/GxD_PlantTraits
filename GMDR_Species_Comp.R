...
#removed from summarize step 
  #sand=mean(as.numeric(X..Sand)),silt=mean(as.numeric(X..Silt))
  ungroup() %>% 
...
#### Normality: Fort Keogh Aerial - Richness ####
...
#### Normality: Thunder Basin Aerial - Richness ####
...
#TB - Aerial - Richness: 2023
#non transformed data
Norm_TB_23_Richness_Ar <- lm(data = subset(CommunityMetrics_Aerial, year == 2023 & site== "TB"), richness  ~ rainfall_reduction*grazing_treatment)
ols_plot_resid_hist(Norm_TB_23_Richness_Ar) 
ols_test_normality(Norm_TB_23_Richness_Ar) #normal

#### Stats: Fort Keogh Aerial - Richness ####
...
#### Stats: Thunder Basin Aerial  - Richness  ####
...
TB_19_Richness_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2019 & site== "TB"), richness ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(TB_19_Richness_Aerial, type = 3) #NS
#adjust drought p-value
p.adjust(0.7337, method = "BH", n=5) #ns

#TB 2020 
TB_20_Richness_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2020 & site== "TB"), richness ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(TB_20_Richness_Aerial, type = 3) #NS
#adjust drought p-value
p.adjust(0.3277, method = "BH", n=5) #ns
...
Richness_FK_ALL_Aerial_Drought<-ggplot(subset(CommunityMetrics_Aerial_Avg,site=="FK"&year>=2019),aes(x=rainfall_reduction,y=Richness_Mean,color=as.factor(year),shape=as.factor(year),fill=as.factor(year))) +  
  ...
  annotate("text", x=16, y=19.7, label = "b) Fort Keogh", size=20)
...
#### Normality: Fort Keogh Aerial - Evar ####
#FK - Aerial - Evar: 2018 
#non transformed data
...
#### Normality: Thunder Basin Aerial - Evar ####
#TB - Aerial - Evar: 2018 
#non transformed data
...
#TB - Aerial - Evar: 2023
#non transformed data
Norm_TB_23_Evar_Ar <- lm(data = subset(CommunityMetrics_Aerial, year == 2023 & site== "TB"), Evar  ~ rainfall_reduction*grazing_treatment)
ols_plot_resid_hist(Norm_TB_23_Evar_Ar) 
ols_test_normality(Norm_TB_23_Evar_Ar) #not normal

#### Stats: Fort Keogh Aerial - Evar ####

#FK 2018 - checking drought and grazing
FK_18_Evar_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2018 & site== "FK"), Evar ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(FK_18_Evar_Aerial, type = 3) #NS

#FK 2019 - just drought
FK_19_Evar_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2019 & site== "FK"), Evar_FK_19_TF ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(FK_19_Evar_Aerial, type = 3) #NS
#adjust drought p-value
p.adjust(0.7026, method = "BH", n=5) #0.05

#FK 2020 - droughtxgrazing
FK_20_Evar_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2020 & site== "FK"), Evar ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(FK_20_Evar_Aerial, type = 3) #NS
#adjust drought p-value
p.adjust(0.6091, method = "BH", n=5) #0.05

#FK 2021- droughtxgrazing
FK_21_Evar_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2021 & site== "FK"), Evar ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(FK_21_Evar_Aerial, type = 3) #drought (p=0.01)
#adjust drought p-value
p.adjust(0.01095, method = "BH", n=5) #0.05


#FK 2022- droughtxgrazing
FK_22_Evar_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2022 & site== "FK"), Evar ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(FK_22_Evar_Aerial, type = 3) #ns
#adjust drought p-value
p.adjust(0.7137, method = "BH", n=5) #0.05


#FK 2023- droughtxgrazing
FK_23_Evar_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2023 & site== "FK"), Evar ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(FK_23_Evar_Aerial, type = 3) #ns
#adjust drought p-value
p.adjust(0.5258, method = "BH", n=5) #0.05

#### Stats:  Thunder Basin Aerial - Evar ####

#TB 2018 - checking drought and grazing
TB_18_Evar_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2018 & site== "TB"), Evar ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(TB_18_Evar_Aerial, type = 3) #NS

#TB 2019 - just drought
TB_19_Evar_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2019 & site== "TB"), Evar ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(TB_19_Evar_Aerial, type = 3) #NS
#adjust drought p-value
p.adjust(0.2377, method = "BH", n=5) #0.045

#TB 2020 - droughtxgrazing
TB_20_Evar_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2020 & site== "TB"), Evar ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(TB_20_Evar_Aerial, type = 3) #ns
#adjust drought p-value
p.adjust(0.2059, method = "BH", n=5) #0.045

#TB 2021- droughtxgrazing
TB_21_Evar_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2021 & site== "TB"), Evar ~ rainfall_reduction+ (1|block) + (1|block:paddock))
anova(TB_21_Evar_Aerial, type = 3) #drought (0.003804)
#adjust drought p-value
p.adjust(0.003531, method = "BH", n=5) #0.045

#TB 2022- droughtxgrazing
TB_22_Evar_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2022 & site== "TB"), Evar_TB_22_TF ~ rainfall_reduction+ (1|block) + (1|block:paddock))
anova(TB_22_Evar_Aerial, type = 3) #ns
#adjust drought p-value
p.adjust(0.2017, method = "BH", n=5) #0.045

#TB 2023- droughtxgrazing
TB_23_Evar_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2023 & site== "TB"), Evar ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(TB_23_Evar_Aerial, type = 3) #ns
#adjust drought p-value
p.adjust(0.8023, method = "BH", n=5) #0.045
...
#### Normality: Fort Keogh Aerial - Shannon ####
...
#TB - Aerial - Shannon: 2023
#non transformed data
Norm_TB_23_Shannon_Ar <- lm(data = subset(CommunityMetrics_Aerial, year == 2023 & site== "TB"), Shannon  ~ rainfall_reduction*grazing_treatment)
ols_plot_resid_hist(Norm_TB_23_Shannon_Ar) 
ols_test_normality(Norm_TB_23_Shannon_Ar) #normal

#### Stats: Fort Keogh Aerial - Shannon's ####

#FK 2018 - checking drought and grazing
FK_18_Shannon_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2018 & site== "FK"), Shannon ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(FK_18_Shannon_Aerial, type = 3) #NS

#FK 2019 - just drought
FK_19_Shannon_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2019 & site== "FK"), Shannon ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(FK_19_Shannon_Aerial, type = 3) #drought (0.02)
#adjust drought p-value
p.adjust(0.007498 , method = "BH", n=5) #0.03

#FK 2020 - droughtxgrazing
FK_20_Shannon_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2020 & site== "FK"), Shannon_20_FK_TF ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(FK_20_Shannon_Aerial, type = 3) #ns
#adjust drought p-value
p.adjust(0.1754 , method = "BH", n=5) #0.03


#FK 2021- droughtxgrazing
FK_21_Shannon_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2021 & site== "FK"), Shannon ~ rainfall_reduction+ (1|block) + (1|block:paddock))
anova(FK_21_Shannon_Aerial, type = 3) #NS
#adjust drought p-value
p.adjust(0.2404 , method = "BH", n=5) #NS

#FK 2022- droughtxgrazing
FK_22_Shannon_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2022 & site== "FK"), Shannon ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(FK_22_Shannon_Aerial, type = 3) #ns
#adjust drought p-value
p.adjust(0.5472 , method = "BH", n=5) #NS

#FK 2023- droughtxgrazing
FK_23_Shannon_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2023 & site== "FK"), Shannon ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(FK_23_Shannon_Aerial, type = 3) #NS
#adjust drought p-value
p.adjust(0.1959 , method = "BH", n=5) #NS

#### Stats: Thunder  Basin Aerial - Shannon's####

#TB 2018 - checking drought and grazing
TB_18_Shannon_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2018 & site== "TB"), Shannon_18_TB_TF ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(TB_18_Shannon_Aerial, type = 3) #grazing (0.008932)
#adjust grazing p-value
p.adjust(0.04, method = "BH", n=5) #.08085

#TB 2019 - just drought
TB_19_Shannon_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2019 & site== "TB"), Shannon ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(TB_19_Shannon_Aerial, type = 3) #NS
#adjust drought p-value
p.adjust(0.3361 , method = "BH", n=5) #NS

#TB 2020 - droughtxgrazing
TB_20_Shannon_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2020 & site== "TB"), Shannon ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(TB_20_Shannon_Aerial, type = 3) #ns
#adjust drought p-value
p.adjust(0.9683 , method = "BH", n=5) #NS

#TB 2021- droughtxgrazing
TB_21_Shannon_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2021 & site== "TB"), Shannon ~ rainfall_reduction+ (1|block) + (1|block:paddock))
anova(TB_21_Shannon_Aerial, type = 3) #NS
#adjust drought p-value
p.adjust(0.2928 , method = "BH", n=5) #NS

#TB 2022- droughtxgrazing
TB_22_Shannon_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2022 & site== "TB"), Shannon ~ rainfall_reduction+ (1|block) + (1|block:paddock))
anova(TB_22_Shannon_Aerial, type = 3) #NS
#adjust grazing p-value
p.adjust(0.8536, method = "BH", n=5) #NS

#TB 2023- droughtxgrazing
TB_23_Shannon_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2023 & site== "TB"), Shannon ~ rainfall_reduction+ (1|block) + (1|block:paddock))
anova(TB_23_Shannon_Aerial, type = 3) #NS
#adjust drought p-value
p.adjust(0.2123 , method = "BH", n=5) #NS
...
Wide_FK_AR_20<-RelCov_Clean%>%
  ...
  mutate(block_slope=paste(block,slope,sep="_"),
         rainfall_reduction_grazing_treatment=paste(grazing_treatment,rainfall_reduction,sep="_")) %>% 
  relocate(block_slope,.after=block) %>% 
  relocate(rainfall_reduction_grazing_treatment,.after=rainfall_reduction)

#### Make new data frame called BC_Data and run an NMDS for each grouping

#Species Comp FK: Aerial 
BC_FK_AR_20<-metaMDS(Wide_FK_AR_20[,18:154])
# Generally, stress < 0.05 provides an excellent represention in reduced 
# dimensions, < 0.1 is great, < 0.2 is good, and stress > 0.3 provides a 
# poor representation
...
#Make a new data table called BC_Meta_Data and use data from Wide_Relative_Cover columns 1-15
BC_Meta_Data_FK_AR_20 <- Wide_FK_AR_20[,1:17] %>% 
  mutate(Yr_Dr_Gr=paste(year,rainfall_reduction,grazing_treatment,sep=".")) %>% 
...
#### Bray Curtis TB Aerial 2023 ####

#Species Comp TB: Aerial 2022
Wide_TB_AR_23<-RelCov_Clean%>%
  filter(site=="TB" & aerial_basal=="Aerial" & year=="2023") 

#### Make new data frame called BC_Data and run an NMDS for each grouping

#Species Comp TB: Aerial 
BC_TB_AR_23<-metaMDS(Wide_TB_AR_23[,16:152])
# Generally, stress < 0.05 provides an excellent represention in reduced 
# dimensions, < 0.1 is great, < 0.2 is good, and stress > 0.3 provides a 
# poor representation

stressplot(BC_TB_AR_23)

#look at species signiciance driving NMDS 
intrinsics_TB_AR_23 <- envfit(BC_TB_AR_23, Wide_TB_AR_23, permutations = 999,na.rm=T)
head(intrinsics_TB_AR_23)
#Make a data frame called sites with 1 column and same number of rows that is in Wide Order weight
sites_TB_AR_23 <- 1:nrow(Wide_TB_AR_23)
#Make a new data table called BC_Meta_Data and use data from Wide_Relative_Cover columns 1-15
...
## Create NMDS numbers Graph ##
#Make a data frame called BC_NMDS and at a column using the first set of "points" in BC_Data and a column using the second set of points.  Group them by watershed
BC_NMDS_TB_AR_23 = data.frame(MDS1 = BC_TB_AR_23$points[,1], MDS2 = BC_TB_AR_23$points[,2],group=BC_Meta_Data_TB_AR_23$rainfall_reduction)
#Make data table called BC_NMDS_Graph and bind the BC_Meta_Data, and BC_NMDS data together
BC_Graph_TB_AR_23 <- cbind(BC_Meta_Data_TB_AR_23,BC_NMDS_TB_AR_23)
plot(BC_TB_AR_23$points,col=as.factor(BC_Meta_Data_TB_AR_23$rainfall_reduction))
#Make a data table called BC_Ord_Ellipses using data from BC_Data and watershed information from BC_Meta_Data.  Display sites and find the standard error at a confidence iinterval of 0.95.  Place lables on the graph
BC_Ord_Ellipses_TB_AR_23<-ordiellipse(BC_TB_AR_23, BC_Meta_Data_TB_AR_23$rainfall_reduction, display = "sites",
                                      kind = "se", conf = 0.95, label = T)
#Make a new empty data frame called BC_Ellipses                
BC_Ellipses_TB_AR_23 <- data.frame()
#Generate ellipses points - switched levels for unique - not sure if it's stil correct but it looks right
for(g in unique(BC_NMDS_TB_AR_23$group)){
  BC_Ellipses_TB_AR_23 <- rbind(BC_Ellipses_TB_AR_23, cbind(as.data.frame(with(BC_NMDS_TB_AR_23[BC_NMDS_TB_AR_23$group==g,],                                                  veganCovEllipse(BC_Ord_Ellipses_TB_AR_23[[g]]$cov,BC_Ord_Ellipses_TB_AR_23[[g]]$center,BC_Ord_Ellipses_TB_AR_23[[g]]$scale)))
                                                            ,group=g))
}
...
Environment_Matrix_FK_AR_18$block_paddock <- with(Environment_Matrix_FK_AR_18, interaction(block, paddock))

#run a perMANOVA
PerMANOVA_FK_AR_18 <- adonis2(formula = Species_Matrix_FK_AR_18~rainfall_reduction,
                              data=Environment_Matrix_FK_AR_18,
                              permutations = 999,
                              method = "bray",
                              type=3,
                              strata=Environment_Matrix_FK_AR_18$block_paddock)
...
Environment_Matrix_FK_AR_19$block_paddock <- with(Environment_Matrix_FK_AR_19, interaction(block, paddock))

#run a perMANOVA -- had to change "(1|block:slope)" to "(1|block/slope)" to make this work
PerMANOVA_FK_AR_19 <- adonis2(formula = Species_Matrix_FK_AR_19~rainfall_reduction,
                              data=Environment_Matrix_FK_AR_19,
                              permutations = 999,
                              method = "bray",
                              type=3,
                              strata=Environment_Matrix_FK_AR_19$block_paddock)
#give a print out of the PermMANOVA
print(PerMANOVA_FK_AR_19) #NS
#adjust drought p-value
p.adjust(0.068, method = "BH", n=5) #NS
...
#adjust drought p-value
p.adjust(0.743 , method = "BH", n=5) #NS
...
#Make a new dataframe with the data from Wide_Relative_Cover all columns
Species_Matrix_FK_AR_20 <- Wide_FK_AR_20[,18:ncol(Wide_FK_AR_20)] %>% 
  select_if(colSums(.) != 0)

Species_Matrix_FK_AR_20<-as.matrix(Species_Matrix_FK_AR_20)

#Make a new dataframe with data from Wide_Relative_Cover columns 1-3
Environment_Matrix_FK_AR_20 <- Wide_FK_AR_20[,1:17]

Environment_Matrix_FK_AR_20$rainfall_reduction=as.factor(Environment_Matrix_FK_AR_20$rainfall_reduction)

Environment_Matrix_FK_AR_20$grazing_treatment=as.factor(Environment_Matrix_FK_AR_20$grazing_treatment)
Environment_Matrix_FK_AR_20$block_paddock <- with(Environment_Matrix_FK_AR_20, interaction(block, paddock))

Environment_Matrix_FK_AR_20$rainfall_reduction_grazing_treatment=as.factor(Environment_Matrix_FK_AR_20$rainfall_reduction_grazing_treatment)

Environment_Matrix_FK_AR_20$block_slope=as.factor(Environment_Matrix_FK_AR_20$block_slope)

#run a perMANOVA

PerMANOVA_FK_AR_20 <- adonis2(formula = Species_Matrix_FK_AR_20~rainfall_reduction,
...
#adjust drought p-value
p.adjust(0.356 , method = "BH", n=5) #NS
...
Environment_Matrix_FK_AR_21$block_paddock <- with(Environment_Matrix_FK_AR_21, interaction(block, paddock))

#run a perMANOVA -- had to change "(1|block:slope)" to "(1|block/slope)" to make this work
PerMANOVA_FK_AR_21 <- adonis2(formula = Species_Matrix_FK_AR_21~rainfall_reduction,
...
#give a print out of the PermMANOVA
print(PerMANOVA_FK_AR_21) #drought (0.025)
#adjust drought p-value
p.adjust(0.024, method = "BH", n=5) #ns
...
#adjust drought p-value
p.adjust(0.386 , method = "BH", n=5) #NS
...
#adjust drought p-value
p.adjust(0.111 , method = "BH", n=5) #NS
...
Environment_Matrix_FK_AR_23$block_paddock <- with(Environment_Matrix_FK_AR_23, interaction(block, paddock))

#run a perMANOVA -- had to change "(1|block:slope)" to "(1|block/slope)" to make this work
PerMANOVA_FK_AR_23 <- adonis2(formula = Species_Matrix_FK_AR_23~rainfall_reduction,
...
#give a print out of the PermMANOVA
print(PerMANOVA_FK_AR_23) #drought (0.002)
#adjust drought p-value
...
#adjust drought p-value
p.adjust(0.018 , method = "BH", n=5) #NS
...
Environment_Matrix_TB_AR_18$block_paddock <- with(Environment_Matrix_TB_AR_18, interaction(block, paddock))
...
Environment_Matrix_TB_AR_19$block_paddock <- with(Environment_Matrix_TB_AR_19, interaction(block, paddock))

#run a perMANOVA
PerMANOVA_TB_AR_19 <- adonis2(formula = Species_Matrix_TB_AR_19 ~ rainfall_reduction,
                              data=Environment_Matrix_TB_AR_19,
                              permutations = 999,
                              method = "bray",
                              type=3,
                              strata=Environment_Matrix_TB_AR_19$block_paddock)
#give a print out of the PermMANOVA
print(PerMANOVA_TB_AR_19) #NS
#adjust drought p-value
p.adjust(0.807, method = "BH", n=5) #NS
...
Environment_Matrix_TB_AR_20$block_paddock <- with(Environment_Matrix_TB_AR_20, interaction(block, paddock))

#run a perMANOVA -- had to change "(1|block:slope)" to "(1|block/slope)" to make this work
PerMANOVA_TB_AR_20 <- adonis2(formula = Species_Matrix_TB_AR_20 ~ rainfall_reduction,
...
#adjust drought p-value
p.adjust(0.504, method = "BH", n=5) #NS
...
Environment_Matrix_TB_AR_21$block_paddock <- with(Environment_Matrix_TB_AR_21, interaction(block, paddock))

#run a perMANOVA -- had to change "(1|block:slope)" to "(1|block/slope)" to make this work
PerMANOVA_TB_AR_21 <- adonis2(formula = Species_Matrix_TB_AR_21 ~ rainfall_reduction,
...
#adjust drought p-value
p.adjust(0.005, method = "BH", n=5) #ns
...
Environment_Matrix_TB_AR_22$block_paddock <- with(Environment_Matrix_TB_AR_22, interaction(block, paddock))

#run a perMANOVA -- had to change "(1|block:slope)" to "(1|block/slope)" to make this work
PerMANOVA_TB_AR_22 <- adonis2(formula = Species_Matrix_TB_AR_22 ~ rainfall_reduction,
...
#adjust drought p-value
p.adjust(0.016, method = "BH", n=5) #0.04
...
#### PERMANOVA TB Aerial 2023 ####

#Make a new dataframe with the data from Wide_Relative_Cover all columns
Species_Matrix_TB_AR_23 <- Wide_TB_AR_23[,16:ncol(Wide_TB_AR_23)] %>% 
  select_if(colSums(.) != 0)
#Make a new dataframe with data from Wide_Relative_Cover columns 1-3
Environment_Matrix_TB_AR_23 <- Wide_TB_AR_23[,1:15]

Environment_Matrix_TB_AR_23$block=as.numeric(Environment_Matrix_TB_AR_23$block)
Environment_Matrix_TB_AR_23$slope=as.numeric(Environment_Matrix_TB_AR_23$slope)
Environment_Matrix_TB_AR_23$block_paddock <- with(Environment_Matrix_TB_AR_23, interaction(block, paddock))

#run a perMANOVA -- had to change "(1|block:slope)" to "(1|block/slope)" to make this work
PerMANOVA_TB_AR_23 <- adonis2(formula = Species_Matrix_TB_AR_23 ~ rainfall_reduction,
...
#adjust drought p-value
p.adjust(0.227, method = "BH", n=5) #NS

#### PERMDISP TB Aerial 2023 ####

TB_AR_23<-Wide_TB_AR_23 %>% 
  mutate(Dr_Gr=paste(rainfall_reduction,grazing_treatment,sep="_")) %>% 
  cbind("observation"=1:nrow(Wide_TB_AR_23))

TB_AR_23$observation=as.factor(TB_AR_23$observation)

#Make a new dataframe and calculate the dissimilarity of the Species_Matrix dataframe
BC_Distance_Matrix_TB_AR_23 <- vegdist(Species_Matrix_TB_AR_23)
#Run a dissimilarity matrix (PermDisp) comparing drought
Dispersion_TB_AR_23_Dr <- betadisper(BC_Distance_Matrix_TB_AR_23,TB_AR_23$rainfall_reduction)
permutest(Dispersion_TB_AR_23_Dr,pairwise = T, permutations = 999) #ns

#Run a dissimilarity matrix (PermDisp) comparing grazing
Dispersion_TB_AR_23_GR <- betadisper(BC_Distance_Matrix_TB_AR_23,TB_AR_23$grazing_treatment)
permutest(Dispersion_TB_AR_23_GR,pairwise = T, permutations = 999)  #NS

#Run a dissimilarity matrix (PermDisp) comparing grazing*Drought
Dispersion_TB_AR_23_DR_GR <- betadisper(BC_Distance_Matrix_TB_AR_23,TB_AR_23$Dr_Gr)
permutest(Dispersion_TB_AR_23_GR,pairwise = T, permutations = 999)  #NS
...
#FK 2023- droughtxgrazing
FK_23_Forb_Ar <- lmerTest::lmer(data = subset(RelCov_Forb, year == 2023 & site== "FK" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:slope))
anova(FK_23_Forb_Ar, type = 3) #NS
...
#TB - Aerial - Relative_Cover: 2023
#non transformed data
Norm_TB_23_RelCov_Forb_Ar <- lm(data = subset(RelCov_Forb, year == 2023 & site== "TB"& aerial_basal=="Aerial"), (Relative_Cover)  ~ rainfall_reduction*grazing_treatment)
ols_plot_resid_hist(Norm_TB_23_RelCov_Forb_Ar) 
ols_test_normality(Norm_TB_23_RelCov_Forb_Ar) #right skewed
...
#TB - Basal - Relative_Cover: 2023 
#non transformed data
Norm_TB_23_RelCov_Forb_Ba <- lm(data = subset(RelCov_Forb, year == 2023 & site== "TB"& aerial_basal=="Basal"), 1/asin(Relative_Cover)  ~ rainfall_reduction*grazing_treatment)
ols_plot_resid_hist(Norm_TB_23_RelCov_Forb_Ba) 
ols_test_normality(Norm_TB_23_RelCov_Forb_Ba) #right skewed
...
#TB 2023- droughtxgrazing
TB_23_Forb_Ar <- lmerTest::lmer(data = subset(RelCov_Forb, year == 2023 & site== "TB" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:slope))
anova(TB_23_Forb_Ar, type = 3) #NS
...
#TB 2023- droughtxgrazing
TB_23_Forb_Ba <- lmerTest::lmer(data = subset(RelCov_Forb, year == 2023 & site== "TB" & aerial_basal=="Basal"), Relative_Cover ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:slope))
anova(TB_23_Forb_Ba, type = 3)  #NS
...
#FK 2023- droughtxgrazing
FK_23_Woody_Ar <- lmerTest::lmer(data = subset(RelCov_Woody, year == 2023 & site== "FK" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:slope))
anova(FK_23_Woody_Ar, type = 3) #ns
...
#TB - Aerial - Relative_Cover: 2023
#non transformed data
Norm_TB_23_RelCov_Woody_Ar <- lm(data = subset(RelCov_Woody, year == 2023 & site== "TB"& aerial_basal=="Aerial"), Relative_Cover  ~ rainfall_reduction*grazing_treatment)
ols_plot_resid_hist(Norm_TB_23_RelCov_Woody_Ar) 
ols_test_normality(Norm_TB_23_RelCov_Woody_Ar) #right skewed
...
#TB 2023- droughtxgrazing
TB_23_Woody_Ar <- lmerTest::lmer(data = subset(RelCov_Woody, year == 2023 & site== "TB" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:slope))
anova(TB_23_Woody_Ar, type = 3) #ns
...
#adjust drought p-value
p.adjust(0.03106, method = "BH", n=5) #0.09
...
#FK 2023- droughtxgrazing
FK_23_BOGR_Ar <- lmerTest::lmer(data = subset(RelCov_BOGR, year == 2023 & site== "FK" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:slope))
anova(FK_23_BOGR_Ar, type = 3) #ns
...
#adjust grazing p-value
p.adjust(0.001, method = "BH", n=5) #0.004589

#TB 2023- droughtxgrazing
TB_23_BOGR_Ar <- lmerTest::lmer(data = subset(RelCov_BOGR, year == 2023 & site== "TB" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:slope))
anova(TB_23_BOGR_Ar, type = 3) #NS
...
ggplot(data=subset(Rank_Abundance_Drought, site=="FK" & year>=2019 & year<=2023 &rank<=10), aes(x=rank, y=avg_cover)) +
  geom_line() +
  geom_point(size=3) +
...
ggplot(data=subset(Rank_Abundance_Drought, site=="TB" & year>=2019 & year<=2023&rank<=10), aes(x=rank, y=avg_cover)) +
  geom_line() +
  geom_point(size=3) +
  #scale_color_manual(values=c("grey50", "grey20"), labels=c("Non-native", "Native"))+
  #scale_shape_discrete(labels=c("Forb","Graminoid", "Succulent", "Woody"),name="Growth Form")+
...
ggplot(data=subset(Rank_Abundance_Drought, site=="FK" & year>=2019 & year<=2023&rank<=10 & Native_Introduced!="NA"), aes(x=rank, y=avg_cover)) +
  geom_line(size=3) +
...
ggplot(data=subset(Rank_Abundance_Drought, site=="TB" & year>=2019 & year<=2023&rank<=10 & Native_Introduced!="NA"), aes(x=rank, y=avg_cover)) +
  geom_line(size=3) +
  geom_point(aes(color=Native_Introduced,shape=Native_Introduced),size=10) +
  scale_color_manual(values=c("#A50F14", "#879673"), labels=c("Non-native", "Native"), name="Plant Status")+
  scale_shape_manual(values=c(16, 17), labels=c("Non-native", "Native"), name="Plant Status")+
...
#### Stats: Fort Keogh Aerial - Relative_Cover's ####

#FK 2018 - checking drought and grazing
FK_18_Relative_Cover_Aerial <- lmerTest::lmer(data = subset(FG_RelCov, year == 2018 & site== "FK" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(FK_18_Relative_Cover_Aerial, type = 3) #NS

#FK 2019 - just drought
FK_19_Relative_Cover_Aerial <- lmerTest::lmer(data = subset(FG_RelCov, year == 2019 & site== "FK" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(FK_19_Relative_Cover_Aerial, type = 3) #ns
#adjust drought p-value
p.adjust(0.25, method = "BH", n=5) #ns

#FK 2020 - droughtxgrazing
FK_20_Relative_Cover_Aerial <- lmerTest::lmer(data = subset(FG_RelCov, year == 2020 & site== "FK" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(FK_20_Relative_Cover_Aerial, type = 3) #ns
#adjust drought p-value
p.adjust(0.1553, method = "BH", n=5) #ns


#FK 2021- droughtxgrazing
FK_21_Relative_Cover_Aerial <- lmerTest::lmer(data = subset(FG_RelCov, year == 2021 & site== "FK" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(FK_21_Relative_Cover_Aerial, type = 3) #NS
#adjust drought p-value
p.adjust(0.2573, method = "BH", n=5) #ns

#FK 2022- droughtxgrazing
FK_22_Relative_Cover_Aerial <- lmerTest::lmer(data = subset(FG_RelCov, year == 2022 & site== "FK" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(FK_22_Relative_Cover_Aerial, type = 3) #ns
#adjust drought p-value
p.adjust(0.4691, method = "BH", n=5) #ns

#FK 2023- droughtxgrazing
FK_23_Relative_Cover_Aerial <- lmerTest::lmer(data = subset(FG_RelCov, year == 2023 & site== "FK" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(FK_23_Relative_Cover_Aerial, type = 3) #NS
#adjust drought p-value
p.adjust(0.5093, method = "BH", n=5) #ns

#### Stats: Thunder  Basin Aerial - Relative_Cover's####

#TB 2018 - checking drought and grazing
TB_18_Relative_Cover_Aerial <- lmerTest::lmer(data = subset(FG_RelCov, year == 2018 & site== "TB" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(TB_18_Relative_Cover_Aerial, type = 3) #ns

#TB 2019 - just drought
TB_19_Relative_Cover_Aerial <- lmerTest::lmer(data = subset(FG_RelCov, year == 2019 & site== "TB" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(TB_19_Relative_Cover_Aerial, type = 3) #NS
#adjust drought p-value
p.adjust(0.6859, method = "BH", n=5) #ns

#TB 2020 - droughtxgrazing
TB_20_Relative_Cover_Aerial <- lmerTest::lmer(data = subset(FG_RelCov, year == 2020 & site== "TB" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(TB_20_Relative_Cover_Aerial, type = 3) #ns
#adjust drought p-value
p.adjust(0.591, method = "BH", n=5) #ns

#TB 2021- droughtxgrazing
TB_21_Relative_Cover_Aerial <- lmerTest::lmer(data = subset(FG_RelCov, year == 2021 & site== "TB" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction+ (1|block) + (1|block:paddock))
anova(TB_21_Relative_Cover_Aerial, type = 3) #NS
#adjust drought p-value
p.adjust(0.8594, method = "BH", n=5) #ns

#TB 2022- droughtxgrazing
TB_22_Relative_Cover_Aerial <- lmerTest::lmer(data = subset(FG_RelCov, year == 2022 & site== "TB" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(TB_22_Relative_Cover_Aerial, type = 3) #ns
#adjust drought p-value
p.adjust(0.755, method = "BH", n=5) #ns

#TB 2023- droughtxgrazing
TB_23_Relative_Cover_Aerial <- lmerTest::lmer(data = subset(FG_RelCov, year == 2023 & site== "TB" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction + (1|block) + (1|block:paddock))
anova(TB_23_Relative_Cover_Aerial, type = 3) #ns
#adjust drought p-value
p.adjust(0.5463, method = "BH", n=5) #ns
...
#### Stats: Fort Keogh Aerial - Absolute's ####
...
#### Stats: Thunder  Basin Aerial - Absolute's####
...
p.adjust(0.1023, method = "BH", n=5) #ns
p.adjust(0.2947, method = "BH", n=5) #ns
p.adjust(0.6717, method = "BH", n=5) #ns
...
p.adjust(0.05765, method = "BH", n=5) #ns
p.adjust(0.62509, method = "BH", n=5) #ns
p.adjust(0.54422, method = "BH", n=5) #ns


#FK 2022
FK_22_Richness_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2022 & site== "FK"), richness ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(FK_22_Richness_Aerial, type = 3) #NS

p.adjust(0.2287, method = "BH", n=5) #ns
p.adjust(0.6844, method = "BH", n=5) #ns
p.adjust(0.9584, method = "BH", n=5) #ns


#FK 2023
FK_23_Richness_Aerial <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2023 & site== "FK"), richness ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(FK_23_Richness_Aerial, type = 3) #NS

p.adjust(0.9589, method = "BH", n=5) #ns
p.adjust(0.8600, method = "BH", n=5) #ns
p.adjust(0.3705, method = "BH", n=5) #ns


#### Stats: Thunder Basin - Grazing  ####

#TB 2020 
TB_20_Richness_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2020 & site== "TB"), richness ~ rainfall_reduction*livestock_util_2019 + (1|block) + (1|block:paddock))
anova(TB_20_Richness_Gr , type = 3) #NS

p.adjust(0.5201, method = "BH", n=5) #ns
p.adjust(0.4883, method = "BH", n=5) #ns
p.adjust(0.4034, method = "BH", n=5) #ns


#TB 2021- droughtxgrazing
TB_21_Richness_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2021 & site== "TB"), richness ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(TB_21_Richness_Gr , type = 3) #NS

p.adjust(0.3465, method = "BH", n=5) #ns
p.adjust(0.7532, method = "BH", n=5) #ns
p.adjust(0.5283, method = "BH", n=5) #ns

#TB 2022- droughtxgrazing
TB_22_Richness_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2022 & site== "TB"), richness ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(TB_22_Richness_Gr , type = 3) #NS

p.adjust(0.4780, method = "BH", n=5) #ns
p.adjust(0.5959, method = "BH", n=5) #ns
p.adjust(0.1660, method = "BH", n=5) #ns

#TB 2023- droughtxgrazing
TB_23_Richness_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2023 & site== "TB"), richness ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(TB_23_Richness_Gr , type = 3) #NS

p.adjust(0.47602, method = "BH", n=5) #ns
p.adjust(0.73211, method = "BH", n=5) #ns
p.adjust(0.08293, method = "BH", n=5) #ns


#### Stats: Fort Keogh Grazing - Evar ####

#FK 2020 
FK_20_Evar_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2020 & site== "FK"), Evar ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(FK_20_Evar_Gr, type = 3) #NS

p.adjust(0.6152, method = "BH", n=5) #ns
p.adjust(0.5040, method = "BH", n=5) #ns
p.adjust(0.6560, method = "BH", n=5) #ns

#FK 2021
FK_21_Evar_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2021 & site== "FK"), Evar ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(FK_21_Evar_Gr, type = 3) #NS

p.adjust(0.01034, method = "BH", n=5) #ns
p.adjust(0.28629, method = "BH", n=5) #ns
p.adjust(0.25471, method = "BH", n=5) #ns


#FK 2022
FK_22_Evar_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2022 & site== "FK"), Evar ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(FK_22_Evar_Gr, type = 3) #ns

p.adjust(0.7087, method = "BH", n=5) #ns
p.adjust(0.1295, method = "BH", n=5) #ns
p.adjust(0.2049, method = "BH", n=5) #ns


#FK 2023
FK_23_Evar_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2023 & site== "FK"), Evar ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(FK_23_Evar_Gr, type = 3) #ns

p.adjust(0.5345, method = "BH", n=5) #ns
p.adjust(0.5793, method = "BH", n=5) #ns
p.adjust(0.7539, method = "BH", n=5) #ns

#### Stats:  Thunder Basin Grazing - Evar ####

#TB 2020 
TB_20_Evar_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2020 & site== "TB"), Evar ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(TB_20_Evar_Gr, type = 3) 

p.adjust(0.2097, method = "BH", n=5) #ns
p.adjust(0.1757, method = "BH", n=5) #ns
p.adjust(0.8973, method = "BH", n=5) #ns

#TB 2021 
TB_21_Evar_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2021 & site== "TB"), Evar ~ rainfall_reduction*grazing_treatment+ (1|block) + (1|block:paddock))
anova(TB_21_Evar_Gr, type = 3) #NS

p.adjust(0.004307, method = "BH", n=5) #ns
p.adjust(0.868587, method = "BH", n=5) #ns
p.adjust(0.456125, method = "BH", n=5) #ns

#TB 2022 
TB_22_Evar_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2022 & site== "TB"), Evar_TB_22_TF ~ rainfall_reduction*grazing_treatment+ (1|block) + (1|block:paddock))
anova(TB_22_Evar_Gr, type = 3) #ns

p.adjust(0.17028, method = "BH", n=5) #ns
p.adjust(0.06725, method = "BH", n=5) #ns
p.adjust(0.06080, method = "BH", n=5) #ns

#TB 2023 
TB_23_Evar_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2023 & site== "TB"), Evar ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(TB_23_Evar_Gr, type = 3) 

p.adjust(0.8075, method = "BH", n=5) #ns
p.adjust(0.2590, method = "BH", n=5) #ns
p.adjust(0.4658, method = "BH", n=5) #ns

#### Stats: Fort Keogh Grazing - Shannon's ####

#FK 2020 
FK_20_Shannon_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2020 & site== "FK"), Shannon_20_FK_TF ~ rainfall_reduction*livestock_util_2019 + (1|block) + (1|block:paddock))
anova(FK_20_Shannon_Gr, type = 3) #ns

p.adjust(0.1577, method = "BH", n=5) #ns
p.adjust(0.1364, method = "BH", n=5) #ns
p.adjust(0.6453, method = "BH", n=5) #ns


#FK 2021 
FK_21_Shannon_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2021 & site== "FK"), Shannon ~ rainfall_reduction*grazing_treatment+ (1|block) + (1|block:paddock))
anova(FK_21_Shannon_Gr, type = 3) #NS

p.adjust(0.2456, method = "BH", n=5) #ns
p.adjust(0.2956, method = "BH", n=5) #ns
p.adjust(0.5299, method = "BH", n=5) #ns

#FK 2022 
FK_22_Shannon_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2022 & site== "FK"), Shannon ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(FK_22_Shannon_Gr, type = 3) #ns

p.adjust(0.5410, method = "BH", n=5) #ns
p.adjust(0.1333, method = "BH", n=5) #ns
p.adjust(0.2217, method = "BH", n=5) #ns

#FK 2023 
FK_23_Shannon_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2023 & site== "FK"), Shannon ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(FK_23_Shannon_Gr, type = 3) #NS

p.adjust(0.2087, method = "BH", n=5) #ns
p.adjust(0.6575, method = "BH", n=5) #ns
p.adjust(0.7203, method = "BH", n=5) #ns

#### Stats: Thunder  Basin Grazing - Shannon's####

#TB 2020 
TB_20_Shannon_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2020 & site== "TB"), Shannon ~ rainfall_reduction*livestock_util_2019 + (1|block) + (1|block:paddock))
anova(TB_20_Shannon_Gr, type = 3) #ns

p.adjust(0.9205, method = "BH", n=5) #ns
p.adjust(0.4014, method = "BH", n=5) #ns
p.adjust(0.8733, method = "BH", n=5) #ns

#TB 2021 
TB_21_Shannon_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2021 & site== "TB"), Shannon ~ rainfall_reduction*grazing_treatment+ (1|block) + (1|block:paddock))
anova(TB_21_Shannon_Gr, type = 3) #NS

p.adjust(0.2833, method = "BH", n=5) #ns
p.adjust(0.3291, method = "BH", n=5) #ns
p.adjust(0.1893, method = "BH", n=5) #ns

#TB 2022 
TB_22_Shannon_Gr <- lmerTest::lmer(data = subset(CommunityMetrics_Aerial, year == 2022 & site== "TB"), Shannon ~ rainfall_reduction*grazing_treatment+ (1|block) + (1|block:paddock))
anova(TB_22_Shannon_Gr, type = 3) #NS

p.adjust(0.8559, method = "BH", n=5) #ns
p.adjust(0.1275, method = "BH", n=5) #ns
p.adjust(0.6302, method = "BH", n=5) #ns
...
p.adjust(0.1334, method = "BH", n=5) #ns
p.adjust(0.2003, method = "BH", n=5) #ns
p.adjust(0.4285, method = "BH", n=5) #ns

#### Stats: Fort Keogh Grazing - Relative_Cover ####

#FK 2020 - droughtxgrazing
FK_20_Relative_Cover_Gr <- lmerTest::lmer(data = subset(FG_RelCov, year == 2020 & site== "FK" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction*livestock_util_2019 + (1|block) + (1|block:paddock))
anova(FK_20_Relative_Cover_Gr, type = 3)

p.adjust(0.8515, method = "BH", n=5) #ns
p.adjust(0.7144, method = "BH", n=5) #ns
p.adjust(0.9621, method = "BH", n=5) #ns


#FK 2021- droughtxgrazing
FK_21_Relative_Cover_Gr <- lmerTest::lmer(data = subset(FG_RelCov, year == 2021 & site== "FK" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(FK_21_Relative_Cover_Gr, type = 3) #NS

p.adjust(0.2615, method = "BH", n=5) #ns
p.adjust(0.8770, method = "BH", n=5) #ns
p.adjust(0.8914, method = "BH", n=5) #ns


#FK 2022- droughtxgrazing
FK_22_Relative_Cover_Gr <- lmerTest::lmer(data = subset(FG_RelCov, year == 2022 & site== "FK" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(FK_22_Relative_Cover_Gr, type = 3) #ns

p.adjust(0.4716, method = "BH", n=5) #ns
p.adjust(0.9068, method = "BH", n=5) #ns
p.adjust(0.9857, method = "BH", n=5) #ns

#FK 2023- droughtxgrazing
FK_23_Relative_Cover_Gr <- lmerTest::lmer(data = subset(FG_RelCov, year == 2023 & site== "FK" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(FK_23_Relative_Cover_Gr, type = 3) #NS

p.adjust(0.4787, method = "BH", n=5) #ns
p.adjust(0.9845, method = "BH", n=5) #ns
p.adjust(0.8188, method = "BH", n=5) #ns

#### Stats: Thunder  Basin Aerial - Relative_Cover's####

#TB 2020 - droughtxgrazing
TB_20_Relative_Cover_Gr <- lmerTest::lmer(data = subset(FG_RelCov, year == 2020 & site== "TB" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction*livestock_util_2019 + (1|block) + (1|block:paddock))
anova(TB_20_Relative_Cover_Gr, type = 3) #ns

p.adjust(0.7967, method = "BH", n=5) #ns
p.adjust(0.7772, method = "BH", n=5) #ns
p.adjust(0.8665, method = "BH", n=5) #ns

#TB 2021- droughtxgrazing
TB_21_Relative_Cover_Gr <- lmerTest::lmer(data = subset(FG_RelCov, year == 2021 & site== "TB" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(TB_21_Relative_Cover_Gr, type = 3) #NS

p.adjust(0.7826, method = "BH", n=5) #ns
p.adjust(0.9299, method = "BH", n=5) #ns
p.adjust(0.8987, method = "BH", n=5) #ns

#TB 2022- droughtxgrazing
TB_22_Relative_Cover_Gr <- lmerTest::lmer(data = subset(FG_RelCov, year == 2022 & site== "TB" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(TB_22_Relative_Cover_Gr, type = 3) #ns

p.adjust(0.6592, method = "BH", n=5) #ns
p.adjust(0.7841, method = "BH", n=5) #ns
p.adjust(0.7656, method = "BH", n=5) #ns

#TB 2023- droughtxgrazing
TB_23_Relative_Cover_Gr <- lmerTest::lmer(data = subset(FG_RelCov, year == 2023 & site== "TB" & aerial_basal=="Aerial"), Relative_Cover ~ rainfall_reduction*grazing_treatment + (1|block) + (1|block:paddock))
anova(TB_23_Relative_Cover_Gr, type = 3) #ns

p.adjust(0.4507, method = "BH", n=5) #ns
p.adjust(0.9773, method = "BH", n=5) #ns
p.adjust(0.6277, method = "BH", n=5) #ns
